...
rmarkdown::render("3_RNA_diagnostics_M.Rmd", output_format="html_document", output_dir = 'reports/M')
rmarkdown::render("4_Ab_diagnostics.Rmd", output_format="html_document", output_dir = 'reports/M')
rmarkdown::render("5_use_ADT_celltypes.Rmd", output_format="html_document", output_dir = 'reports/M')
rmarkdown::render("6_DS_analysis_M.Rmd", output_format="html_document", output_dir = 'reports/M')
