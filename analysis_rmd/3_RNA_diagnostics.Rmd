...
execute = TRUE
.libPaths(c(.libPaths(),"/home/asonrel/R/x86_64-pc-linux-gnu-library/4.0", "/home/sorjuela/R/x86_64-pc-linux-gnu-library/4.0/"))
do_seurat <- TRUE
...
```{r}
sample_key <- read.table("metadata.csv",
                       header = TRUE,
                       sep = ",",
